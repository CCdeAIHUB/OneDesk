...
- Android cache schema version `2` clears older trusted desktop records and `scheme:*` snapshots once so previous demo/incorrect connection cache cannot appear as real connected content.
