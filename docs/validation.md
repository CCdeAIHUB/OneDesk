...
- 2026-07-23 local validation: 43 .NET contract/integration tests passed; Android JVM tests and APK build passed; Windows x64 self-contained publish passed. Stable Android identity derivation, trusted-record migration, and QUIC re-pairing after simulated uninstall/reinstall are covered. No ADB device was connected for destructive real-device reinstall validation.
